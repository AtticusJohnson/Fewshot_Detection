...
### data generation
The voc_label id used to generate a **voc_train.txt** file, which writelines all image path from voc datasets, like **"D:/dataset/VOCdevkit/VOC2007/JPEGImages/000012.jpg"**
